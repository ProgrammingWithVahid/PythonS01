...
if year % 4 == 0:  # اگر بر 4 بخش‌پذیر باشد
        if year % 100 == 0:  # اما اگر بر 100 هم بخش‌پذیر باشد
            if year % 400 == 0:  # اگر بر 400 هم بخش‌پذیر باشد، کبیسه است
                return True
            else:
                return False  # در غیر این صورت، کبیسه نیست
        else:
            return True  # اگر بر 100 بخش‌پذیر نبود، کبیسه است
    else:
        return False  # اگر بر 4 بخش‌پذیر نباشد، کبیسه نیست
 ```
